...
- - working on mock data and structuring ( working on it )
  - re-analysis of data and restructuring (working on it - needs some restructurig)
...
- - requirement collection (done)
  ...
  - mongoose methods (find, findone, findByIdAndUpdate , findByIdAndDelete) (done )
  ...
  - introducing new components for connections and requests (working on it )
